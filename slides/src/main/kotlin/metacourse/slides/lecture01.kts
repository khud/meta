...
import metacourse.slides.twoColsFrame
...
val doc = document(createPreamble("Введение")) {
    ...
    section("Введение") {
        ...
        twoColsFrame("Компиляторы", "../assets/compilers.png") {
    ...
    section("Частичные вычисления") {
        twoColsFrame("Валентин Фёдорович Турчин", "../assets/turchin.jpg") {
            +"""Валентин Фёдорович Турчин (14 февраля 1931, г. Подольск, Московская область — 7 апреля 2010, Нью-Йорк, США) — 
            ...
            «Международной амнистии». Отец Петра Валентиновича Турчина."""//.footnote("https://www.economist.com/finance-and-economics/2020/10/22/can-too-many-brainy-people-be-a-dangerous-thing")
        }

        twoColsFrame("Академик А. П. Ершов", "../assets/ershov.png") {
            +"""Андрей Петрович Ершов (19 апреля 1931, Москва — 8 декабря 1988, там же) — советский учёный, 
            ...
            фонд русского языка при Институте русского языка АН СССР.""" // FIXME: footnote линк на Википедию
        }
